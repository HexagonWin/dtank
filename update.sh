...
chmod a+r $BBSDIR/bin/wooky
chmod a+r $BBSDIR/bin/checktime
chmod a+r $BBSDIR/bin/chatt
cp doltank.log $BBSDIR/logo
chmod a+r $BBSDIR/logo/doltank.log

# 다끝났다.
echo update.sh의 끝을 알립니다.
